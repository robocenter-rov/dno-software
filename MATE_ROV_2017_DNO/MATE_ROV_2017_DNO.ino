...
void setup() {
	...
	*/
	...
	PCA9685ServoMotor_t* camera1_periphery = new PCA9685ServoMotor_t(rotation_sensor, pwm2, 14);
	PCA9685ServoMotor_t* camera2_periphery = new PCA9685ServoMotor_t(rotation_sensor, pwm2, 15);
