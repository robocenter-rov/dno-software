...
void HMC58X3::getValues(float *x,float *y,float *z) {
  ...
  uncalibrated_values[0] = xr;
  uncalibrated_values[1] = yr;
  uncalibrated_values[2] = zr;

  //transformation(values_from_magnetometer, x, y, z);

  //calibration_matrix[3][3] is the transformation matrix
  //replace M11, M12,..,M33 with your transformation matrix data
  const static float calibration_matrix[3][3] =
  {
	  { 1.440404, -0.035237, 0.029610 },
	  { -0.035237, 1.508498, 0.023555 },
	  { 0.029610, 0.023555, 1.554418 }

  /*{0.00288081, -0.000070474, 0.00005922},
  { -0.000070474, 0.003017, 0.00004711 },
  { 0.00005922, 0.00004711, 0.00310884 }*/
  };
  //bias[3] is the bias
  //replace Bx, By, Bz with your bias data
  const static float bias[3] =
  {
	  264.702545,
	  -87.678276,
	  -10.901404
